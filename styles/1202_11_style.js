...
var style_1202_11 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var offsetY = 3;
    var placement = 'point';
    if (feature.get("ALTURA_SOBRE_NIVEL_MAR") !== null) {
        labelText = String(feature.get("ALTURA_SOBRE_NIVEL_MAR"));
    }
    var style = [ new ol.style.Style({
        image: new ol.style.RegularShape({radius: 6.26 + size,
                                          points: 4,
                                          radius2: 0,
                                          angle: Math.PI / 4,
